...
Record = collections.namedtuple(
    'Record',
    'date,actual_mean_temp,actual_min_temp,actual_max_temp,average_min_temp,average_max_temp,record_min_temp,'
    'record_max_temp,record_min_temp_year,record_max_temp_year,actual_precipitation,average_precipitation,'
...
def cold_days() -> List[Record]:
    return sorted(data, key=lambda r: r.actual_min_temp, reverse=True)
